...
| Runtime requirement | Deno 2.9.6 for direct execution, exactly Deno 2.6.8 for worker execution, or a browser with standardized Wasm exception handling | Go 1.25 or later with wazero `v1.12.1-0.20260908083515-451613caac44`; the shared rules are in the [SDK contract](docs/sdk-contract.md)                            |
